...
{
	//Display features initialization
	...
	DisplayWindow DisplayWindowObj_(&GC.getTeam1(), &GC.getTeam2());

	GC.setDisplayMsgQueue(&DisplayWindowObj_.getMsgQueue());
	...
	Thread DisplayWindowThread(&DisplayWindowObj_);
