...
public:
	...
	GameController(PlayersideWrite * ps1_w, MsgQueue * GameController)
		: PlayersideWriteObj1_(ps1_w), GameControllerMsgQueue_(GameController)
		{
			WebPage_Information = false;
		}

		GameController(PlayersideWrite * ps1_w, PlayersideWrite * ps2_w, MsgQueue * GameController)
			: PlayersideWriteObj1_(ps1_w), PlayersideWriteObj2_(ps2_w), GameControllerMsgQueue_(GameController)
			{
				WebPage_Information = false;
			}
